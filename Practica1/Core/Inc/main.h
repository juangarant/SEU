...
/* Botón de usuario de la Nucleo (PC13) */
...
/* Botones de usuario BtR y BtL */
#define BtR_Pin         GPIO_PIN_6
#define BtR_GPIO_Port   GPIOB

#define BtL_Pin         GPIO_PIN_7
#define BtL_GPIO_Port   GPIOC
